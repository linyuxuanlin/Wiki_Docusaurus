...
<div class="altium-ecad-viewer" data-project-src="b64c0655-31fb-497a-b97a-cdad7c50aa78"  data-enabled-views="pcb,3d" data-active-view="pcb" style={{height:'500px',border-style:'solid',border-width:'1px',overflow:'hidden',max-width:'1280px',max-height:'700px',box-sizing:'border-box'}}></div>
...
style={{width:'1200px',height:'40px',backgroundColor:'#3385ff'}}
