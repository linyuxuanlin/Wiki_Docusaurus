...
在 [**rafaelaroca/web-serial-terminal**](https://github.com/rafaelaroca/web-serial-terminal) 的基础上增添 [**inorganik/debugout.js**](https://github.com/inorganik/debugout.js)，实现打印日志及导出的功能。
