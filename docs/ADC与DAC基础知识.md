...
![](https://cos.wiki-power.com/img/20220724175332.jpg)
...
DAC（Digital-to-Analog Canverter），指数字 / 模拟转换器。可将数字量转换为成比例的模拟电压或电流。举个例子，计算机可能产生范围从 `00000000` 到 `11111111` 的数字输出，DAC 将其转换为范围从 0 到 10V 的电压。
...
![](https://cos.wiki-power.com/img/20220724172844.png)
...
![](https://cos.wiki-power.com/img/20220724165753.png)
...
![](https://cos.wiki-power.com/img/20220724171436.png)
