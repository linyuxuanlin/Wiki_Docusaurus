...
- 当采样控制信号 $v_L$ 为高电平时，使 MOS 管 $T$ 导通，$v_1$ 经过电阻 $R_1$ 和 MOS 管 $T$，给电容 $C_H$ 充电。
- 若取 $R_1=R_F$，则充电结束后 $v_0=v_c=-v_1$。
- 当采样控制信号 $v_L$ 跌落回电平时，MOS 管 $T$ 截止，电容 $C_H$ 上的电压不会突变，所以 $v_0$ 也能保持一段时间，采样结果得以被记录下来。
