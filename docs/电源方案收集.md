...
![](https://wiki-media-1253965369.cos.ap-guangzhou.myqcloud.com/img/20210713154408.png)
...
$R_5$ 大约取值 10 kΩ，在参考设计中，我们需要输出 4.96 V，所以取 $R_5$ = 10.2 kΩ，$R_6$ = 1.96 kΩ。另外，阻值为 51.1 Ω 的 $R_4$，是用来破坏通路以提供测试点的。
