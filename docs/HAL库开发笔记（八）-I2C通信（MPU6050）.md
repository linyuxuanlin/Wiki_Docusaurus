...
这里我们调用带卡尔曼滤波的 MPU6050 库：[**leech001/MPU6050**](https://github.com/leech001/MPU6050)，将下载的 `mpu6050.c` 和 `mpu6050.h` 文件分别拷贝进 `Src` 和 `Inc` 文件夹内，并在 STM32CubeIDE/Keil 内将其添加到项目中。
