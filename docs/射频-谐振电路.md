...
其中，$\frac{V_{out}}{V_{in}}$ 是以 dB 表示的损耗；$R_s$ 表示源电阻；$X_C$ 表示容抗，$X_C=\frac{1}{j\omega C}$。
...
我们将谐振电路的中心频率与其 3-dB 带宽之比定义为谐振电路的 Q 值，也称为负载 Q 值，因为它描述了实际电路内或负载条件下谐振电路的通带特性。谐振电路的负载 Q 取决于三个主要因素：
